...
$(function(){
  ...
  function change_page(page_id){
      ...
      $(".page-edit-link").show();
      $("#page-content").attr("src" , base_url+"/page/index?page_id="+page_id);
      $("#edit-link").attr("href" , base_url+"/page/edit?page_id="+page_id);
      $("#copy-link").attr("href" , base_url+"/page/edit?item_id="+item_id+"&copy_page_id="+page_id);
      $("#share-page-link").html("http://"+window.location.host+base_url+"/"+item_id+"?page_id="+page_id);
      $("#delete-link").attr("href" , base_url+"/page/delete?page_id="+page_id);
