...
class Alipay extends \Think\Pay\Pay {
    ...
    public function buildRequestForm(\Think\Pay\PayVo $vo) {
        ...
        $param = array(
            ...
            'notify_url' => 'http://test3.gouchehui.com:8082'. U("Pay/notify", array('apitype' => 'alipay', 'method' => 'notify')),
            'return_url' => 'http://test3.gouchehui.com:8082'.U("Pay/notify", array('apitype' => 'alipay', 'method' => 'notify')),
