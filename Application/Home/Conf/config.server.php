<?php
namespace Home\Conf;
define('JAVA_API', 'https://www.woodche.com/YchLrestServer/api/');
$SITE_URL = "http://www.gouchehui.com/";
define('URL_CALLBACK', "" . $SITE_URL . "member.php/public/callback?type=");
define('LOGIN_URL', 'http://www.gouchehui.com/member.php/Public/');
define('MEMBER_URL', 'http://www.gouchehui.com/member.php/MemberGeneral/');
